...
export default function Clientes() {
  ...
  const totalPendiente = clientes.reduce((sum, c) => sum + (parseFloat(c.balance_pendiente) || 0), 0);
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Balance Pendiente</th>
              ...
              {clientesFiltrados.map((cliente) => {
                ...
                return (
                  <tr key={cliente.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-red-600">
              ...
              <div key={cliente.id} className="p-4 hover:bg-gray-50">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-red-600">{formatCurrency(balancePendiente)}</p>
                  </div>
