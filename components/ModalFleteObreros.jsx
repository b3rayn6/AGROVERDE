...
export default function ModalFleteObreros({ pesada, user, onClose, onSuccess }) {
  ...
  const handleSaveFlete = async () => {
    ...
    try {
      ...
      const valorTotalFlete = pesada.cantidad_sacos * parseFloat(fleteData.precio_flete);
      ...
      const fleteRecord = {
        ...
        precio_flete: parseFloat(fleteData.precio_flete),
        valor_total_flete: valorTotalFlete,
        user_id: userId
      };
