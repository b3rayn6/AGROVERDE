...
export default function FacturasCompra() {
  ...
  const cargarDatos = async () => {
    ...
    if (!suplidoresRes.error) setSuplidores(suplidoresRes.data || []);
    if (!mercanciasRes.error) setMercancias(mercanciasRes.data || []);
  };
      ...
      if (editandoFactura) {
        ...
        const { data: facturaActualizada, error: errorActualizar } = await supabase
          ...
          .update({
            ...
            itbis,
            total,
            balance_pendiente: total - editandoFactura.monto_pagado,
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6 border border-gray-100">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => generarPDFFacturasCompra(facturas)}
